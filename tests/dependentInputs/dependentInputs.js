jQuery(document).ready(function() {
	...
	test("when I add a new row, if the container, fields or values are empty, it should throw an error", function() {
		jqMock.expectThatExceptionThrown(function() {  
			DependentInputs.addRow('#blah');
		}, is.exception());
		jqMock.expectThatExceptionThrown(function() {  
			DependentInputs.addRow('#test-form', 'span');
		}, is.exception());
		jqMock.expectThatExceptionThrown(function() {  
			DependentInputs.addRow('#test-form', 'label', 'span');
		}, is.exception());
	});
